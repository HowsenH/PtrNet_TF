...
net_arg.add_argument('--input_dim', type=int, default=5, help='')
...
data_arg.add_argument('--max_data_length', type=int, default=5)
# data_arg.add_argument('--train_num', type=int, default=1000000)
data_arg.add_argument('--train_num', type=int, default=995000)
data_arg.add_argument('--valid_num', type=int, default=1000)
data_arg.add_argument('--test_num', type=int, default=1000)
data_arg.add_argument('--y_path', type=str, default='data/distance_matrix5-20/n=5_index2_y.npy')
data_arg.add_argument('--x_path', type=str, default='data/distance_matrix5-20/n=5_index2_x.npy')
